...
{if isset($U_PHOTO_ADMIN) or isset($U_CADDIE) or !empty($U_SET_AS_REPRESENTATIVE)}
    <li>
      <a id="adminSwitchLink" href="#">
        <span class="pwg-icon pwg-icon-cog"></span>
...
{/if}
		...
		{strip}{if isset($current.U_DOWNLOAD)}
          <li>
            <a id="downloadSwitchLink" href="{$current.U_DOWNLOAD}" title="{'Download this file'|@translate}">
...
{/if} {* has formats *}
	...
	<div class="browsePath">
		{$SECTION_TITLE}
		{if ($stripped_responsive.showTitleOnBrowsePath)}{$LEVEL_SEPARATOR}{$current.TITLE}{/if}
	</div>
...
<div id="content">
 ...
 <!-- Image HD --> 
  <div id="theImageHigh" style="display:none;">
	...
	{if (($stripped_responsive.imageCaption != 'description') && isset($COMMENT_IMG))}
...
<div id="theImageAndTitle">
 ...
 <div style="clear: both;"></div>
 	...
 	<div id="tabZone">
		...
		{if (($display_count > 0) && ((isset($U_ADMIN)) || ($stripped_responsive.infoTabAdminOnly == false)))}
