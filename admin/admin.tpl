<div class="titrePage">
	<h2>Responsive stripped Theme v{$options.paramVersion} Configuration</h2>
</div>
	...
	<div>
		<fieldset>
			...
			<ul>
				...
				<li><label>
					<span class="property">{'Menu on the right'|@translate}</span>&nbsp;
					<input type="checkbox" name="f_menuOnRight" {if $options.menuOnRight}checked{/if}>
				</label></li>
			</ul>
		</fieldset>
		<fieldset>
